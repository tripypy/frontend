<template>
  <div class="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-20">

    <div class="w-full max-w-6xl">
      <h1
        class="text-6xl cursor-pointer tracking-tighter transition-transform text-white font-bold"
      >
        <span class="bg-black px-3 rounded-t-2xl">TRAVEL<span class="text-[#9BCCC4]">.</span></span>
      </h1>
    </div>
